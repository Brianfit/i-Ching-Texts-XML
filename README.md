...
The Wilhelm Baynes example here is not my work. I found it at [Ivan Zderadika's git here](https://github.com/izderadicka/iching/blob/master/text/en/hexagrams.xml) but it looks like an extremley robust XML format that we might use for other translations. 
